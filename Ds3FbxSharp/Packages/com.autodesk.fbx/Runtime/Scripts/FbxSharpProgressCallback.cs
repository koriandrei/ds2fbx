...
internal abstract class FbxSharpProgressCallback : global::System.IDisposable {
  ...
  private void SwigDirectorConnect() {
    if (SwigDerivedClassHasMethod("Progress", swigMethodTypes0))
      swigDelegate0 = new SwigDelegateFbxSharpProgressCallback_0(SwigDirectorMethodProgress);
  ...
  private bool SwigDirectorMethodProgress(float percentage, string status) {
